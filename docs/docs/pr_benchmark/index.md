# PR-Insight Pull Request Benchmark

## Methodology

PR-Insight PR Benchmark evaluates and compares the performance of Large Language Models (LLMs) in analyzing pull request code and providing meaningful code suggestions.
...
- For each pull request, we have pre-generated suggestions from eleven different top-performing models using the PR-Insight `improve` tool. The prompt for response generation can be found [here](https://github.com/repolens-ai/pr-insight/blob/main/pr_insight/settings/code_suggestions/pr_code_suggestions_prompts_not_decoupled.toml). 

- To benchmark a model, we generate its suggestions for the same pull requests and ask a high-performing judge model to **rank** the new model's output against the pre-generated baseline suggestions. We utilize OpenAI's `o3` model as the judge, though other models have yielded consistent results. The prompt for this ranking judgment is available [here](https://github.com/repolens-ai/pr-insight-settings/tree/main/benchmark).
...
- [Example 1](https://www.khulnasoft.com/images/pr_insight_benchmark/example_results1.html)
- [Example 2](https://www.khulnasoft.com/images/pr_insight_benchmark/example_results2.html)
- [Example 3](https://www.khulnasoft.com/images/pr_insight_benchmark/example_results3.html)
- [Example 4](https://www.khulnasoft.com/images/pr_insight_benchmark/example_results4.html)
