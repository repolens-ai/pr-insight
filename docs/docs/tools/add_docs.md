...
![Add Docs](https://khulnasoft.com/images/pr_insight/add_docs_comment.png){width=512}

The tool will generate documentation suggestions as inline code suggestions:

![Add Docs Result](https://khulnasoft.com/images/pr_insight/add_docs_result.png){width=512}
