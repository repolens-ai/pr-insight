...
![Generate Labels](https://khulnasoft.com/images/pr_insight/generate_labels_comment.png){width=512}

The tool will analyze the PR and add appropriate labels:

![Generate Labels Result](https://khulnasoft.com/images/pr_insight/generate_labels_result.png){width=512}
...
You can define your own custom labels in the `[custom_labels]` section. See the [custom_labels.toml](https://github.com/repolens-ai/pr-insight/blob/main/pr_insight/settings/custom_labels.toml) file for examples.
