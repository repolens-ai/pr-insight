      ...
      - name: Run PR Insight on Issues
        ...
        with:
          ...
          args: |
            ...
            python -m pr_insight.cli --issue_url=$ISSUE_URL --pr_help_docs.repo_url="..." --pr_help_docs.docs_path="..." --pr_help_docs.openai_key=$OPENAI_KEY && \
...
Under the section `pr_help_docs`, the [configuration file](https://github.com/repolens-ai/pr-insight/blob/main/pr_insight/settings/configuration.toml#L50) contains options to customize the 'help docs' tool:
