...
Under the section `pr_update_changelog`, the [configuration file](https://github.com/repolens-ai/pr-insight/blob/main/pr_insight/settings/configuration.toml#L50) contains options to customize the 'update changelog' tool:
