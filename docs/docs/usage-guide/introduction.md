After [installation](../installation/index.md), there are three basic ways to invoke PR-Insight:

1. Locally running a CLI command
2. Online usage - by [commenting](https://github.com/repolens-ai/pr-insight/pull/229#issuecomment-1695021901){:target="_blank"} on a PR
