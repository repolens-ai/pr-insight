...
from pr_insight.secret_providers.aws_secrets_manager_provider import AWSSecretsManagerProvider
...
class TestAWSSecretsManagerProvider:
    ...
    def _provider(self):
        ...
        with patch('pr_insight.secret_providers.aws_secrets_manager_provider.get_settings') as mock_get_settings, \
             patch('pr_insight.secret_providers.aws_secrets_manager_provider.boto3.client') as mock_boto3_client:
