...
class TestConvertToMarkdown:
    ...
    def test_key_issues_to_review(self):
        ...
        reference_link = 'https://github.com/repolense/pr-insight/pull/1/files#diff-hashvalue-R174'
...
class TestBR:
    def test_br1(self):
        ...
        expected_output = ('<ul><li>Imported <code>FilePatchInfo</code> and <code>EDIT_TYPE</code> '
                           'from <code>pr_insight.algo.types</code> <br>instead of '
                           '<code>pr_insight.git_providers.git_provider</code>.</ul>')
