...
class TestGiteaProvider:
    @patch('pr_insight.git_providers.gitea_provider.get_settings')
    @patch('pr_insight.git_providers.gitea_provider.giteapy.ApiClient')
    def test_gitea_provider_auth_header(self, mock_api_client_cls, mock_get_settings):
        ...
        from pr_insight.git_providers.gitea_provider import RepoApi
