...
class TestGitLabProvider:
    ...
    def gitlab_provider(self, mock_gitlab_client, mock_project):
        with patch('pr_insight.git_providers.gitlab_provider.gitlab.Gitlab', return_value=mock_gitlab_client), \
             patch('pr_insight.git_providers.gitlab_provider.get_settings') as mock_settings:
