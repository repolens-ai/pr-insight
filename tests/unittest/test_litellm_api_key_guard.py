...
from pr_insight.algo.ai_handlers.litellm_ai_handler import DUMMY_LITELLM_API_KEY, LiteLLMAIHandler
...
class TestApiKeyGuard:
    ...
    async def test_dummy_key_not_forwarded(self, monkeypatch):
        ...
        with patch("pr_insight.algo.ai_handlers.litellm_ai_handler.acompletion",
