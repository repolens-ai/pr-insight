...
class TestPRUpdateChangelog:
    ...
    def changelog_tool(self, mock_git_provider, mock_ai_handler):
        ...
        with patch('pr_insight.tools.pr_update_changelog.get_git_provider', return_value=lambda url: mock_git_provider), \
             patch('pr_insight.tools.pr_update_changelog.get_main_pr_language', return_value="Python"), \
             patch('pr_insight.tools.pr_update_changelog.get_settings') as mock_settings:
    ...
    async def test_run_without_push_support(self, changelog_tool, mock_git_provider):
        ...
        with patch('pr_insight.tools.pr_update_changelog.get_settings') as mock_settings:
    ...
    async def test_run_with_push_support(self, changelog_tool, mock_git_provider):
        ...
        with patch('pr_insight.tools.pr_update_changelog.get_settings') as mock_settings, \
             patch('pr_insight.tools.pr_update_changelog.retry_with_fallback_models') as mock_retry, \
             patch('pr_insight.tools.pr_update_changelog.sleep'):
