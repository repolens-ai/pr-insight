...
class TestSecretProviderFactory:
    ...
    def test_get_secret_provider_none_when_not_configured(self):
        with patch('pr_insight.secret_providers.get_settings') as mock_get_settings:
            settings = MagicMock()
    ...
    def test_get_secret_provider_google_cloud_storage(self):
        with patch('pr_insight.secret_providers.get_settings') as mock_get_settings:
            ...
            with patch('pr_insight.secret_providers.google_cloud_storage_secret_provider.GoogleCloudStorageSecretProvider') as MockProvider:
    ...
    def test_get_secret_provider_aws_secrets_manager(self):
        with patch('pr_insight.secret_providers.get_settings') as mock_get_settings:
            ...
            with patch('pr_insight.secret_providers.aws_secrets_manager_provider.AWSSecretsManagerProvider') as MockProvider:
                mock_instance = MagicMock()
                MockProvider.return_value = mock_instance
